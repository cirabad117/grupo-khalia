            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12 d-flex align-items-center">
                        ...
                        <data-simple  style="padding:5px;"font-size="15px"value="[[cliente.id]]" title="clave de producto"></data-simple>

                        <data-simple  style="padding:5px;"font-size="15px"value="[[cliente.tipoMembresia.tipo]]" title="tipo de vigencia"></data-simple>
                        <data-simple  style="padding:5px;"font-size="15px"value="[[showEstatus(cliente)]]" title="estatus de membresia"></data-simple>

                        <data-simple  style="padding:5px;"font-size="15px"value="[[PolymerUtils_getDateString(cliente._fechaLimite)]]" title="vigencia de membresia"></data-simple>
                    ...
                    <div class="col-md-12 mt-2">
                        <paper-tabs selected="{{selected}}">
                            <paper-tab>Actualizar membresia</paper-tab>
                            <paper-tab>Cancelar producto</paper-tab>
                        ...
                        <iron-pages selected="{{selected}}">
                            <div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <paper-button class="flex-fill" style="background-color:var(--paper-green-500);color:white;" on-click="modificaMembresia">actualizar</paper-button>
